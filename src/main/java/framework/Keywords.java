...
public class Keywords {
	...
	/**
	 * Este método realiza la acción de pulsar sobre un elemento de la pantalla
	 * 
	 * @author jairo
	...
	/**
	 * Este método realiza la acción de escribir sobre un elemento de la pantalla un
	...
	/**
	 * Este método recoge una propiedad(text, value, class...) concreta de un
	 * elemento
	 * 
	 * @author jairo
	 * @param arrayElement Es un array con los datos para localizar el objeto. Este
	...
	/**
	 * Este método verificará que aparece un texto concreto en un elemento de la
	 * pantalla
	 * 
	 * @author jairo
	 * @param arrayElement Es un array con los datos para localizar el objeto. Este
	...
	/**
	 * Este método verificará que aparece un texto que contiene el esperado
	 * 
	 * @author jairo
	 * @param arrayElement Es un array con los datos para localizar el objeto. Este
	 *                     contiene el tag y el valor de la búsqueda del elemento.
	...
	/**
	 * Este método verificará que existe un elemento en pantalla
	 * 
	 * @author jairo
	 * @param arrayElement Es un array con los datos para localizar el objeto. Este
	 *                     contiene el tag y el valor de la búsqueda del elemento.
	...
	/**
	 * Este método verificará un elemento en pantalla. Fallando, en caso de no
	 * existir.
	 * 
	 * @author jairo
	 * @param arrayElement Es un array con los datos para localizar el objeto. Este
	...
	/**
	 * Este método selecciona una opción de un selector desplegable
	 * 
	 * @author jairo
	 * @param arrayElement Es un array con los datos para localizar el objeto. Este
	 *                     contiene el tag y el valor de la búsqueda del elemento.
	 ...
	 * 
	 * @param sec El tiempo que se quiera parar la ejecución en segundos.
	 * @author Jairo
	 */
	 ...
	 * 
	 * @param arrayElement Es un array que representa un atributo estático de la clase
	 *           PageObject.
	 * @param sec El tiempo en segundos que dura la espera.
	 * @return El elemento por el que se está esperando a que está presente.
	 * @author Jairo
	 */
	...
	/**
	 * Este método almacena un dato para poder consultarlo cuando se necesite dentro
	 * de la ejecucción
	 * 
	 * @author jairo
	...
	/**
	 * Este método recupera un dato guardado previamente
	 * 
	 * @author jairo
	 * @param key Clave para localizar el dato
	 */
	...
	/**
	 * Método que espera la carga completa de la página
